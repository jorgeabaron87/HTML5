...
var game = {
	//Start initializing objects, preloading asseets and display start screen
	init: function(){
	...
	animate:function(){
		...
		// Draw the background with parallaz scrolling
	...
	countHeroesAndVillains:function(){
		...
		for(var body = box2d.world.GetBodyList(); body; body = body = body.GetNext()){
			var entity = body.GetUserData();
			if(entity){
				if(entity.type == "hero"){
...
var loader={
	loaded:true,
	loadedCount:0, // Asset that have been loaded so far
	totalCount:0, // Total number of asset that need to be loaded
...
var box2d = {
	...
	createRectangle: function(entity,definition){
		...
		fixtureDef.driction = entity.friction;
